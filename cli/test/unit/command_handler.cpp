...
// ridge_bt_command_handler, ridge_bt_fgt_command_handler, ridge_fc_command_handler,
// horizon_command_handler, genius_command_handler, quell_command_handler,
// dbuct_ridge_bt_command_handler, and dbuct_* (including quell-fc / dbuct-quell / dbuct-quell-fc).
    ...
    switch (kind) {
        ...
        case cli_solver_kind::ridge_bt:
            ridge_bt_command_handler(
                ...
                CommandHandlerParamTest::kSimProgressInterval);
            break;
        case cli_solver_kind::ridge_bt_fgt:
        ...
        case cli_solver_kind::dbuct_genius:
            dbuct_genius_command_handler(
                ...
                CommandHandlerParamTest::kExplorationConstant);
            break;
        case cli_solver_kind::dbuct_genius_fc:
