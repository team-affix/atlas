...
struct dbuct_horizon_fc_command_handler {
    ...
    using PrintBindings  = print_bindings<dbuct_horizon_fc_runtime, printer_t>;
    ...
    using SolveLoop      = solve_loop<dbuct_horizon_fc_runtime, printer_t, PrintBindings, PrintProgress,
