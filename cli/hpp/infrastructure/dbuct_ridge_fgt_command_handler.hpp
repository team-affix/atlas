...
struct dbuct_ridge_fgt_command_handler {
    ...
    using PrintBindings  = print_bindings<dbuct_ridge_fgt_runtime, printer_t>;
    ...
    using SolveLoop      = solve_loop<dbuct_ridge_fgt_runtime, printer_t, PrintBindings, PrintProgress,
