#ifndef QUELL_FC_COMMAND_HANDLER_HPP
#define QUELL_FC_COMMAND_HANDLER_HPP
...
struct quell_fc_command_handler {
    ...
    using PrintBindings = print_bindings<quell_fc_runtime, printer_t>;
    ...
    using SolveLoop     = solve_loop<quell_fc_runtime, printer_t, PrintBindings, PP,
...
private:
    ...
    std::optional<quell_fc_runtime> runtime_;
    steady_now clock_;
