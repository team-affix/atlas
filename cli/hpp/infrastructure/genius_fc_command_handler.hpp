#ifndef GENIUS_FC_COMMAND_HANDLER_HPP
#define GENIUS_FC_COMMAND_HANDLER_HPP
...
struct genius_fc_command_handler {
    ...
    using SolveLoop     = solve_loop<genius_fc_runtime, printer_t, PrintBindings, PP,
...
private:
    ...
    std::optional<genius_fc_runtime> runtime_;
    steady_now clock_;
