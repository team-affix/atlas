...
struct dbuct_genius_command_handler {
    ...
    using PrintBindings  = print_bindings<dbuct_genius_runtime, printer_t>;
    ...
    using SolveLoop      = solve_loop<dbuct_genius_runtime, printer_t, PrintBindings, PrintProgress,
