#ifndef RIDGE_FC_COMMAND_HANDLER_HPP
#define RIDGE_FC_COMMAND_HANDLER_HPP
...
struct ridge_fc_command_handler {
    ...
    using PrintBindings  = print_bindings<ridge_fc_runtime, printer_t>;
    ...
    using SolveLoop      = solve_loop<ridge_fc_runtime, printer_t, PrintBindings, PrintProgress,
...
private:
    ...
    std::optional<ridge_fc_runtime> runtime_;
    steady_now clock_;
