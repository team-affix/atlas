#ifndef RIDGE_BT_FGT_COMMAND_HANDLER_HPP
#define RIDGE_BT_FGT_COMMAND_HANDLER_HPP
...
struct ridge_bt_fgt_command_handler {
    using printer_t = expr_printer<var_names, functor_names>;
    using SolveTimer     = solve_timer<steady_now>;
    using PrintBindings  = print_bindings<ridge_bt_fgt_runtime, printer_t>;
    ...
    using SolveLoop      = solve_loop<ridge_bt_fgt_runtime, printer_t, PrintBindings, PrintProgress,
...
private:
    ...
    std::optional<ridge_bt_fgt_runtime> runtime_;
    steady_now clock_;
