...
struct dbuct_genius_fc_command_handler {
    ...
    using PrintBindings  = print_bindings<dbuct_genius_fc_runtime, printer_t>;
    ...
    using SolveLoop      = solve_loop<dbuct_genius_fc_runtime, printer_t, PrintBindings, PrintProgress,
