...
using test_srt_subgoals_activator_t = srt_subgoals_activator<
    MockSrtActiveGoals, MockSrtActiveGoals, MockSubgoalsActivator>;
...
struct SrtSubgoalsActivatorTest : public ::testing::Test {
    ...
    test_srt_subgoals_activator_t activator{srt_active_goals, srt_active_goals, subgoals_activator};
