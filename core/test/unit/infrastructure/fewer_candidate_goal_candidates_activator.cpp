// fewer_candidate_goal_candidates_activator: activate then set leaf score from -count.
...
using activator_t = fewer_candidate_goal_candidates_activator<
    MockActivateGoalCandidates, MockComputeActiveGoalValue, MockSetActiveGoalValue>;

}  // namespace

struct FewerCandidateGoalCandidatesActivatorTest : public ::testing::Test {
...
TEST_F(FewerCandidateGoalCandidatesActivatorTest, SetsScoreAfterSuccessfulActivate) {
...
TEST_F(FewerCandidateGoalCandidatesActivatorTest, SkipsSetWhenActivateFails) {
