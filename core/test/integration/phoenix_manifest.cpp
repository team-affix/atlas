// Integration: phoenix_manifest — wiring identity + sim lifecycle via MCTS stack.

#include <gtest/gtest.h>
#include "infrastructure/db.hpp"
#include "infrastructure/expr_pool.hpp"
#include "infrastructure/initial_goal_exprs.hpp"
#include "infrastructure/phoenix_manifest.hpp"
...
class PhoenixManifestIntegrationTest : public ::testing::Test {
protected:
    ...
    phoenix_manifest make_manifest(size_t max_resolutions = kMaxResolutions) {
        return phoenix_manifest{
            database,
            initial_goals,
            kInitialVarCount,
            max_resolutions,
...
TEST_F(PhoenixManifestIntegrationTest, WiringConstructsWithEmptyDbAndNoGoals) {
    /*
     * Intent: phoenix_manifest constructs without throwing on an empty problem.
     * initial goals: (none)
     * rules: (none)
     */
...
TEST_F(PhoenixManifestIntegrationTest, WiringChooserDistinctFromOuterAndInnerLifecycle) {
    /*
     * Intent: uct_.chooser is distinct from outer and base setup/teardown components.
     * initial goals: (none)
     * rules: (none)
     */
    phoenix_manifest manifest = make_manifest();
...
TEST_F(PhoenixManifestIntegrationTest, WiringCdclDistinctFromJoint) {
    /*
...
TEST_F(PhoenixManifestIntegrationTest, SimLifecycleTrailDepthRestoresAfterEmptyRun) {
    /*
...
TEST_F(PhoenixManifestIntegrationTest, SimLifecycleClearsActiveGoalsAfterEmptyRun) {
    /*
...
TEST_F(PhoenixManifestIntegrationTest, SimLifecycleTrailDepthRestoresAfterConflictedRun) {
    /*
...
TEST_F(PhoenixManifestIntegrationTest, SimMctsDecisionGeneratorRecordsDecisionWithFixedSeed) {
    /*
...
TEST_F(PhoenixManifestIntegrationTest, SolverVacuousSolvedOnEmptyProblem) {
    /*
...
TEST_F(PhoenixManifestIntegrationTest, SolverFindsSingleUnitSolution) {
    /*
