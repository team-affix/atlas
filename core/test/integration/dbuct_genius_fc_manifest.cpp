// Integration: dbuct_genius_fc_manifest — FC scores + frame undo (camping).
...
#include "infrastructure/dbuct_genius_fc_manifest.hpp"
...
class DbuctGeniusFcManifestIntegrationTest : public ::testing::Test {
protected:
    ...
    dbuct_genius_fc_manifest make_manifest(size_t max_resolutions = kMaxResolutions) {
        return dbuct_genius_fc_manifest{
            database,
            initial_goals,
            kInitialVarCount,
            max_resolutions,
...
TEST_F(DbuctGeniusFcManifestIntegrationTest, InitialActivateSetsFewerCandidateScore) {
    ...
    dbuct_genius_fc_manifest manifest = make_manifest();
...
TEST_F(DbuctGeniusFcManifestIntegrationTest, FramePopUndoesRpScores) {
    dbuct_genius_fc_manifest manifest = make_manifest();
...
TEST_F(DbuctGeniusFcManifestIntegrationTest, WiringConstructsWithEmptyProblem) {
