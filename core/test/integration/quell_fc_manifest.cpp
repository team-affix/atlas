// Integration: quell_fc_manifest — fewer-candidate scores + quell remaining-work reward.
...
class QuellFcManifestIntegrationTest : public ::testing::Test {
protected:
    ...
    quell_fc_manifest make_manifest(size_t max_resolutions = kMaxResolutions) {
        return quell_fc_manifest{
            database,
            initial_goals,
            kInitialVarCount,
            max_resolutions,
...
TEST_F(QuellFcManifestIntegrationTest, InitialActivateSetsFewerCandidateScore) {
