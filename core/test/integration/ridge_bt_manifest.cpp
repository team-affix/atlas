// Integration: ridge_bt_manifest — wiring identity + sim lifecycle via MCTS stack.

#include <gtest/gtest.h>
#include "infrastructure/db.hpp"
#include "infrastructure/expr_pool.hpp"
#include "infrastructure/initial_goal_exprs.hpp"
#include "infrastructure/ridge_bt_manifest.hpp"
...
class RidgeBtManifestIntegrationTest : public ::testing::Test {
protected:
    ...
    ridge_bt_manifest make_manifest(size_t max_resolutions = kMaxResolutions) {
        return ridge_bt_manifest{
            database,
            initial_goals,
            kInitialVarCount,
            max_resolutions,
...
TEST_F(RidgeBtManifestIntegrationTest, WiringConstructsWithEmptyDbAndNoGoals) {
    /*
     * Intent: ridge_bt_manifest constructs without throwing on an empty problem.
     * initial goals: (none)
     * rules: (none)
     */
...
TEST_F(RidgeBtManifestIntegrationTest, WiringChooserDistinctFromOuterAndInnerLifecycle) {
    /*
     * Intent: uct_.chooser is distinct from outer and base setup/teardown components.
     * initial goals: (none)
     * rules: (none)
     */
    ridge_bt_manifest manifest = make_manifest();
...
TEST_F(RidgeBtManifestIntegrationTest, WiringCdclDistinctFromJoint) {
    /*
...
TEST_F(RidgeBtManifestIntegrationTest, SimLifecycleTrailDepthRestoresAfterEmptyRun) {
    /*
...
TEST_F(RidgeBtManifestIntegrationTest, SimLifecycleClearsActiveGoalsAfterEmptyRun) {
    /*
...
TEST_F(RidgeBtManifestIntegrationTest, SimLifecycleTrailDepthRestoresAfterConflictedRun) {
    /*
...
TEST_F(RidgeBtManifestIntegrationTest, SimMctsDecisionGeneratorRecordsDecisionWithFixedSeed) {
    /*
...
TEST_F(RidgeBtManifestIntegrationTest, SolverVacuousSolvedOnEmptyProblem) {
    /*
...
TEST_F(RidgeBtManifestIntegrationTest, SolverFindsSingleUnitSolution) {
    /*
