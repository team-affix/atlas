...
struct i_lineage_pool {
    ...
    virtual const goal_lineage* goal(const resolution_lineage* parent, subgoal_id idx) = 0;
    virtual const resolution_lineage* resolution(const goal_lineage* parent, rule_id idx) = 0;
