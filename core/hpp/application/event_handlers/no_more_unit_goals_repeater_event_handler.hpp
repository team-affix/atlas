...
struct no_more_unit_goals_repeater_event_handler : cancellable_event_handler<no_more_unit_goals_event, sim_termination_condition_reached_event, sim_started_event> {
