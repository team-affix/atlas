...
struct conflicted_detector_avoidance_empty_event_handler : cancellable_event_handler<avoidance_empty_event, sim_termination_condition_reached_event, sim_started_event> {
