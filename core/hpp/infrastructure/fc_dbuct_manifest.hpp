#ifndef FC_DBUCT_MANIFEST_HPP
#define FC_DBUCT_MANIFEST_HPP
...
struct fc_dbuct_manifest {
    ...
    fc_dbuct_manifest(visits_table_t&, visits_table_t&, value_table_t&, value_table_t&,
                      tree_walker&, rollout_t&, exploration_constant_t&, value_delta_t&,
                      double, mcts_tree_node_id);
