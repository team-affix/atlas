#ifndef DBUCT_RIDGE_TERMINATE_SIM_HPP
#define DBUCT_RIDGE_TERMINATE_SIM_HPP

#include <vector>
#include "value_objects/lineage.hpp"

template<typename IComputeMctsReward, typename ISetValueDelta, typename ITerminateDbuct>
struct dbuct_ridge_terminate_sim {
    dbuct_ridge_terminate_sim(IComputeMctsReward&, ISetValueDelta&, ITerminateDbuct&);
...
dbuct_ridge_terminate_sim<ICMR, ISVD, ITD>::dbuct_ridge_terminate_sim(
...
dbuct_ridge_terminate_sim<ICMR, ISVD, ITD>::terminate() {
