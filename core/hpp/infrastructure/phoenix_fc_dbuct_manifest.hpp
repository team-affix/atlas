#ifndef PHOENIX_FC_DBUCT_MANIFEST_HPP
#define PHOENIX_FC_DBUCT_MANIFEST_HPP
...
struct phoenix_fc_dbuct_manifest {
    ...
    phoenix_fc_dbuct_manifest(visits_table_t&, visits_table_t&, value_table_t&, value_table_t&,
