...
struct horizon_manifest {
    ...
    horizon_goal_activator& horizon_goal_activator_;
    srt_goal_deactivator& srt_goal_deactivator_;
    horizon_goal_deactivator& horizon_goal_deactivator_;
    ...
    horizon_initial_goal_activator& horizon_initial_goal_activator_;
    std::mt19937& rng_;
    mcts_decision_generator& mcts_decision_generator_;
    resolver& resolver_;
    horizon_resolver& horizon_resolver_;
    set_up_sim& set_up_sim_;
    horizon_tear_down_sim& tear_down_sim_;
    run_sim& run_sim_;
    horizon_reward& horizon_reward_;
    mcts_sim& mcts_sim_;
    solver& solver_;
...
private:
    ...
    struct activator_wiring {
        ...
        candidate_activator candidate_activator_;
        candidate_deactivator candidate_deactivator_;
        std::optional<horizon_goal_activator> horizon_goal_activator_;
        std::optional<horizon_goal_deactivator> horizon_goal_deactivator_;
    ...
    struct router_wiring {
        ...
        std::optional<horizon_initial_goal_activator> horizon_initial_goal_activator_;
    ...
    struct orchestration_wiring {
        ...
        std::optional<horizon_tear_down_sim> tear_down_sim_;
        std::optional<resolver> resolver_;
        std::optional<horizon_resolver> horizon_resolver_;
        horizon_reward horizon_reward_;
