#ifndef RP_FEWER_CANDIDATE_GOAL_CANDIDATES_ACTIVATOR_HPP
#define RP_FEWER_CANDIDATE_GOAL_CANDIDATES_ACTIVATOR_HPP
...
struct rp_fewer_candidate_goal_candidates_activator {
...
rp_fewer_candidate_goal_candidates_activator<IAGC, ICAV, ISAGV>::
rp_fewer_candidate_goal_candidates_activator(
...
template<typename IAGC, typename ICAV, typename ISAGV>
bool rp_fewer_candidate_goal_candidates_activator<IAGC, ICAV, ISAGV>::
