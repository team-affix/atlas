#ifndef DBUCT_GENIUS_FC_MANIFEST_HPP
#define DBUCT_GENIUS_FC_MANIFEST_HPP
...
struct dbuct_genius_fc_manifest {
    ...
    using solver_t                      = dbuct_solver<srt_initial_goals_activator_t, run_sim_t, decision_memory_t,
                                          dbuct_genius_terminate_sim_t, dbuct_sim_t, cdcl_t, mhu_t,
