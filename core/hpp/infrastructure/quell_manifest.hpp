#ifndef QUELL_MANIFEST_HPP
#define QUELL_MANIFEST_HPP
...
struct quell_manifest {
    ...
    using resolver_t                  = resolver<quell_goal_deactivator_t, srt_subgoals_activator_t, goal_candidates_deactivator_t, chosen_goal_candidates>;
