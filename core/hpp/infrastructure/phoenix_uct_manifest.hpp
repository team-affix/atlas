#ifndef PHOENIX_UCT_MANIFEST_HPP
#define PHOENIX_UCT_MANIFEST_HPP
...
struct phoenix_uct_manifest {
    ...
    phoenix_uct_manifest(visits_table_t&, visits_table_t&, value_table_t&, value_table_t&,
