#ifndef GENIUS_UCT_MANIFEST_HPP
#define GENIUS_UCT_MANIFEST_HPP
...
struct genius_uct_manifest {
    ...
    genius_uct_manifest(visits_table_t&, visits_table_t&, value_table_t&, value_table_t&,
