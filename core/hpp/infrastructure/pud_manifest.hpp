...
struct pud_manifest {
    ...
    using unfolder_t = pud_unfolder<
        queries_t, normalizer_t, normalizer_t, expr_pool,
        pud_node_lvc, pud_rule_id_pool,
        pud_node_added_unifications, pud_node_added_body_goals, pud_node_lvc,
        pud_node_children, pud_node_parent, pud_node_interval, order_maintenance,
        pud_node_interval, pud_node_touched_reps, queries_t>;
