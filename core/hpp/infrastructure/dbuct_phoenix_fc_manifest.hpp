#ifndef DBUCT_PHOENIX_FC_MANIFEST_HPP
#define DBUCT_PHOENIX_FC_MANIFEST_HPP
...
struct dbuct_phoenix_fc_manifest {
    ...
    using dbuct_t                  = phoenix_fc_dbuct_manifest;
    ...
    using heuristic_rollout_frame_hub_t = dbuct_rp_heuristic_rollout_frame_hub<
                    hub_t, hub_t, rp_srt_active_goals_t, rp_srt_active_goals_t>;
    ...
    using run_sim_t                     = run_sim<dbuct_frontier_ready, solution_detector_t, conflict_detector_t,
                                          ...
                                          dbuct_joint_t, rp_fewer_candidates_elimination_router_t, resolver_t,
    ...
    using solver_t                      = dbuct_solver<srt_initial_goals_activator_t, run_sim_t, decision_memory_t,
                                          dbuct_ridge_terminate_sim_t, dbuct_sim_t, cdcl_t, mhu_t,
