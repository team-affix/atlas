#ifndef DBUCT_HORIZON_MANIFEST_HPP
#define DBUCT_HORIZON_MANIFEST_HPP
...
struct dbuct_horizon_manifest {
    ...
    using dbuct_horizon_terminate_sim_t = dbuct_horizon_terminate_sim<
                                          horizon_reward_t, typename dbuct_t::delta_t, dbuct_sim_t>;
    ...
    using solver_t                      = dbuct_solver<srt_initial_goals_activator_t, run_sim_t, decision_memory_t,
                                          dbuct_horizon_terminate_sim_t, dbuct_sim_t, cdcl_t, mhu_t, elimination_router_t,
