#ifndef PHOENIX_MANIFEST_HPP
#define PHOENIX_MANIFEST_HPP
...
#include "infrastructure/phoenix_uct_manifest.hpp"
...
struct phoenix_manifest {
    ...
    using uct_t = phoenix_uct_manifest;
