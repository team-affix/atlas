#ifndef DBUCT_RIDGE_FGT_MANIFEST_HPP
#define DBUCT_RIDGE_FGT_MANIFEST_HPP
...
struct dbuct_ridge_fgt_manifest {
    ...
    using cdcl_t  = dbuct_fgt_cdcl_elimination_generator<
