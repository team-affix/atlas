#ifndef DBUCT_QUELL_TERMINATE_SIM_HPP
#define DBUCT_QUELL_TERMINATE_SIM_HPP

#include <vector>
#include "value_objects/lineage.hpp"

template<typename IComputeMctsReward, typename ISetValueDelta, typename ITerminateDbuct>
struct dbuct_quell_terminate_sim {
    dbuct_quell_terminate_sim(IComputeMctsReward&, ISetValueDelta&, ITerminateDbuct&);
...
dbuct_quell_terminate_sim<ICMR, ISVD, ITD>::dbuct_quell_terminate_sim(
...
dbuct_quell_terminate_sim<ICMR, ISVD, ITD>::terminate() {
