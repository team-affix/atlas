#ifndef DBUCT_GENIUS_MANIFEST_HPP
#define DBUCT_GENIUS_MANIFEST_HPP
...
struct dbuct_genius_manifest {
    ...
    using dbuct_t                  = genius_dbuct_manifest;
    ...
    using run_sim_t                     = run_sim<dbuct_frontier_ready, solution_detector_t, conflict_detector_t,
                                          ...
                                          dbuct_joint_t, elimination_router_t, horizon_resolver_t, get_unit_resolution_t,
    ...
    using solver_t                      = dbuct_solver<srt_initial_goals_activator_t, run_sim_t, decision_memory_t,
                                          dbuct_genius_terminate_sim_t, dbuct_sim_t, cdcl_t, mhu_t, elimination_router_t,
    ...
    dbuct_genius_terminate_sim_t  dbuct_genius_terminate_sim_;
