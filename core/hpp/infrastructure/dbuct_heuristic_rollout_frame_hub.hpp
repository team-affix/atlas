#ifndef DBUCT_HEURISTIC_ROLLOUT_FRAME_HUB_HPP
#define DBUCT_HEURISTIC_ROLLOUT_FRAME_HUB_HPP
...
struct dbuct_heuristic_rollout_frame_hub {
    dbuct_heuristic_rollout_frame_hub(
...
dbuct_heuristic_rollout_frame_hub<IPSF, IPopSF, IPHMF, IPopHMF>::
dbuct_heuristic_rollout_frame_hub(
...
template<typename IPSF, typename IPopSF, typename IPHMF, typename IPopHMF>
void dbuct_heuristic_rollout_frame_hub<IPSF, IPopSF, IPHMF, IPopHMF>::push_solver_frame() {
    push_solver_frame_.push_solver_frame();
...
dbuct_heuristic_rollout_frame_hub<IPSF, IPopSF, IPHMF, IPopHMF>::pop_solver_frame() {
