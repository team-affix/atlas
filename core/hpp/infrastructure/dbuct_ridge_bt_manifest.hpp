#ifndef DBUCT_RIDGE_BT_MANIFEST_HPP
#define DBUCT_RIDGE_BT_MANIFEST_HPP
...
struct dbuct_ridge_bt_manifest {
    ...
    using cdcl_t  = dbuct_bt_cdcl_elimination_generator<
