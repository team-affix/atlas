#ifndef GENIUS_DBUCT_MANIFEST_HPP
#define GENIUS_DBUCT_MANIFEST_HPP
...
struct genius_dbuct_manifest {
    ...
    genius_dbuct_manifest(visits_table_t&, visits_table_t&, value_table_t&, value_table_t&,
