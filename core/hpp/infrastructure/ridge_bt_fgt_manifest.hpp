#ifndef RIDGE_BT_FGT_MANIFEST_HPP
#define RIDGE_BT_FGT_MANIFEST_HPP
...
struct ridge_bt_fgt_manifest {
    ...
    using cdcl_t  = fgt_bt_cdcl_elimination_generator;
    ...
    using ridge_tear_down_sim_t = ridge_tear_down_sim<
        ridge_reward_t, typename uct_t::delta_t, typename uct_t::terminator_t, tear_down_sim_t>;
