#ifndef DBUCT_PHOENIX_MANIFEST_HPP
#define DBUCT_PHOENIX_MANIFEST_HPP
...
#include "infrastructure/phoenix_dbuct_manifest.hpp"
...
struct dbuct_phoenix_manifest {
    ...
    using dbuct_t                  = phoenix_dbuct_manifest;
    ...
    using dbuct_ridge_terminate_sim_t = dbuct_ridge_terminate_sim<
                                          ridge_reward_t, typename dbuct_t::delta_t, dbuct_sim_t>;
