...
dbuct_ridge_manifest::dbuct_ridge_manifest(
    ...
    : globalizer_(),
      ...
      frame_count_(),
      nearest_decision_(trail_),
      avoidance_unit_boundary_(nearest_decision_, frame_count_, trail_),
      ...
      decision_router_(decision_memory_, resolution_memory_, nearest_decision_,
      ...
      rng_(random_seed),
      dbuct_sim_(trail_, lineage_pool_, cdcl_, frame_count_, rng_,
      ...
      run_sim_(frontier_ready_, solution_detector_, conflict_detector_,
               ...
               resolver_, get_unit_resolution_, decision_router_,
               decision_router_, resolution_memory_, max_resolutions),
      learn_reapply_(mhu_, elimination_router_, conflict_detector_,
                     unit_goal_detector_, unit_goals_),
      solver_(srt_initial_goals_activator_, run_sim_, decision_memory_,
              ridge_reward_, dbuct_sim_, cdcl_, learn_reapply_) {}
