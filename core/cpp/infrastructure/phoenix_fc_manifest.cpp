...
phoenix_fc_manifest::phoenix_fc_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      uct_(mcts_visits_table_, mcts_visits_table_,
           ...
           rng_, mcts_root_tree_node_.get_mcts_root_node()),
      ridge_tear_down_sim_(ridge_reward_, value_delta_, uct_.terminator, tear_down_sim_),
      ...
      solver_(set_up_sim_, ridge_tear_down_sim_, run_sim_,
