...
ridge_bt_fgt_manifest::ridge_bt_fgt_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      ridge_tear_down_sim_(ridge_reward_, uct_.delta, uct_.terminator, tear_down_sim_),
      ...
      solver_(set_up_sim_, ridge_tear_down_sim_, repeat_solutions_filter_,
