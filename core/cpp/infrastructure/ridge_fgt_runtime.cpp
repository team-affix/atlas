...
bool ridge_fgt_runtime::next() {
    return manifest_.driver_.next();
}

bool ridge_fgt_runtime::solved() const {
...
size_t ridge_fgt_runtime::decision_depth() const {
    return manifest_.decision_memory_.count();
}

lemma ridge_fgt_runtime::derive_decision_lemma() const {
    return manifest_.decision_memory_.derive_decision_lemma();
}

lemma ridge_fgt_runtime::derive_resolution_lemma() const {
