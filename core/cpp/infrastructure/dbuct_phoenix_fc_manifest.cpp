...
dbuct_phoenix_fc_manifest::dbuct_phoenix_fc_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      dbuct_(dbuct_visits_table_, dbuct_visits_table_,
             ...
             rng_, grant_k, mcts_root_tree_node_.get_mcts_root_node()),
      ...
      hub_(solver_frame_depth_tracker_, solver_frame_depth_tracker_,
           ...
           mhu_, mhu_,
           cdcl_, cdcl_),
      heuristic_rollout_frame_hub_(hub_, hub_, rp_srt_active_goals_, rp_srt_active_goals_),
      ...
      resolver_(srt_goal_deactivator_, rp_fewer_candidate_srt_subgoals_activator_,
      ...
      dbuct_sim_(heuristic_rollout_frame_hub_, heuristic_rollout_frame_hub_,
                 ...
                 check_mcts_choice_is_rule_choice_),
      dbuct_ridge_terminate_sim_(ridge_reward_, value_delta_, dbuct_sim_),
      ...
      solver_(srt_initial_goals_activator_, run_sim_, decision_memory_,
              dbuct_ridge_terminate_sim_, dbuct_sim_, cdcl_, mhu_,
              rp_fewer_candidates_elimination_router_,
