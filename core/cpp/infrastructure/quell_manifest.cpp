...
quell_manifest::quell_manifest(
    ...
    : globalizer_(),
      ...
      uct_(mcts_visits_table_, mcts_visits_table_,
           ...
           rng_, exploration_constant, mcts_root_tree_node_.get_mcts_root_node()),
      quell_tear_down_sim_(quell_reward_, uct_.delta, uct_.terminator,
