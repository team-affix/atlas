...
bool dbuct_elimination_backlog::is_backlogged_elimination(const resolution_lineage* rl) const {
...
void dbuct_elimination_backlog::push_frame() { frame_stack_.push(frame{}); }
