...
dbuct_ridge_fgt_manifest::dbuct_ridge_fgt_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      dbuct_sim_(hub_, hub_, solver_frame_depth_tracker_,
                 decision_memory_,
                 avoidance_unit_boundary_, avoidance_unit_boundary_,
                 dbuct_.frame_stack, dbuct_.value_stack_controller,
                 dbuct_.chooser, dbuct_.terminator,
                 check_mcts_choice_is_rule_choice_),
      dbuct_ridge_terminate_sim_(ridge_reward_, dbuct_.delta, dbuct_sim_),
      ...
      seen_solutions_(),
      repeat_solutions_filter_(run_sim_, resolution_memory_,
                               seen_solutions_, seen_solutions_, lineage_pool_),
      solver_(srt_initial_goals_activator_, repeat_solutions_filter_, decision_memory_,
              dbuct_ridge_terminate_sim_, dbuct_sim_, cdcl_, mhu_, elimination_router_,
