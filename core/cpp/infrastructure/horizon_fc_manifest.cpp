...
horizon_fc_manifest::horizon_fc_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      horizon_tear_down_sim_(horizon_reward_, value_delta_, uct_.terminator,
      ...
      solver_(set_up_sim_, horizon_tear_down_sim_, run_sim_,
