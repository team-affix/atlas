...
genius_fc_manifest::genius_fc_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      uct_(mcts_visits_table_, mcts_visits_table_,
           ...
           scope_walker_, mcts_rollout_, exploration_constant_, value_delta_,
           mcts_root_scope_node_.get_mcts_root_node()),
      genius_tear_down_sim_(uct_.terminator, goal_weights_, cumulative_grounded_weight_, tear_down_sim_),
      ...
      solver_(set_up_sim_, genius_tear_down_sim_, run_sim_,
