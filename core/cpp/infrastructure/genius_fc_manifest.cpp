...
genius_fc_manifest::genius_fc_manifest(
    ...
    : globalizer_(),
      ...
      mcts_sim_(mcts_visits_table_, mcts_visits_table_,
                ...
                scope_walker_, mcts_rollout_, value_delta_,
                exploration_constant_, mcts_root_scope_node_),
      genius_set_up_sim_(mcts_sim_, set_up_sim_),
      genius_tear_down_sim_(mcts_sim_, goal_weights_, cumulative_grounded_weight_, tear_down_sim_),
      ...
      solver_(genius_set_up_sim_, genius_tear_down_sim_, run_sim_,
