...
dbuct_genius_fc_manifest::dbuct_genius_fc_manifest(
    db& database,
    ...
    : globalizer_(),
      ...
      value_delta_(ridge_reward_, horizon_reward_),
      mcts_root_scope_node_(),
      exploration_constant_(srt_active_goals_,
                            ridge_exploration_constant,
                            horizon_exploration_constant),
      dbuct_(dbuct_visits_table_, dbuct_visits_table_,
             dbuct_value_table_, dbuct_value_table_,
             scope_walker_, dbuct_rollout_, exploration_constant_, value_delta_,
             grant_k, mcts_root_scope_node_.get_mcts_root_node()),
      ...
      heuristic_rollout_frame_hub_(horizon_hub_, horizon_hub_,
      ...
      resolver_(horizon_goal_deactivator_, rp_fewer_candidate_srt_subgoals_activator_,
      ...
      dbuct_sim_(heuristic_rollout_frame_hub_, heuristic_rollout_frame_hub_,
                 ...
                 check_mcts_choice_is_rule_choice_),
      dbuct_genius_terminate_sim_(dbuct_sim_),
      ...
      solver_(srt_initial_goals_activator_, run_sim_, decision_memory_,
              dbuct_genius_terminate_sim_, dbuct_sim_, cdcl_, mhu_,
              rp_fewer_candidates_elimination_router_,
