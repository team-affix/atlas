...
bool dbuct_horizon_fc_runtime::solved() const {
...
size_t dbuct_horizon_fc_runtime::decision_depth() const {
    return manifest_.decision_memory_.count();
}

double dbuct_horizon_fc_runtime::cgw() const {
    return manifest_.cumulative_grounded_weight_.get();
}

lemma dbuct_horizon_fc_runtime::derive_decision_lemma() const {
    return manifest_.decision_memory_.derive_decision_lemma();
}

lemma dbuct_horizon_fc_runtime::derive_resolution_lemma() const {
