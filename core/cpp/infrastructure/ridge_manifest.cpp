...
ridge_manifest::ridge_manifest(
    ...
    : globalizer_(),
      ...
      compute_fewer_candidate_goal_value_(goal_candidate_rules_),
      srt_active_goals_heuristics_(srt_active_goals_, srt_active_goals_,
      ...
      goal_activator_(goal_exprs_, goal_candidate_rules_, srt_active_goals_heuristics_,
      ...
      initial_goal_activator_(initial_goals, make_initial_goal_lineage_,
                              goal_exprs_, goal_candidate_rules_, srt_active_goals_heuristics_),
      ...
      goal_candidates_activator_(querier_, lineage_pool_,
                                   ...
                                   unit_goals_),
      fewer_candidate_goal_candidates_activator_(
          goal_candidates_activator_, compute_fewer_candidate_goal_value_,
          srt_active_goals_heuristics_),
      subgoals_activator_(lineage_pool_, goal_activator_, database,
                          goal_candidates_activator_),
      fewer_candidate_srt_subgoals_activator_(
          subgoals_activator_, srt_active_goals_heuristics_, srt_active_goals_,
          srt_active_goals_, compute_fewer_candidate_goal_value_,
          srt_active_goals_heuristics_),
      initial_goals_activator_(initial_goals, initial_goal_activator_,
                               make_initial_goal_lineage_, fewer_candidate_goal_candidates_activator_),
      srt_initial_goals_activator_(srt_active_goals_, initial_goals_activator_),
      resolver_(srt_goal_deactivator_, fewer_candidate_srt_subgoals_activator_,
      ...
      tear_down_sim_(elimination_backlog_, unit_goals_, decision_memory_, resolution_memory_,
                     goal_candidate_rules_, goal_exprs_, srt_active_goals_heuristics_,
      ...
      mcts_value_table_(),
      tree_walker_(),
      goal_rollout_(srt_active_goals_heuristics_),
      rule_rollout_(rng_),
